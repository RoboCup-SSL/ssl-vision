...
void proto_BuildDescriptors_messages_5frobocup_5fssl_5fdetection_2eproto() {
...
struct StaticDescriptorInitializer_messages_5frobocup_5fssl_5fdetection_2eproto {
  StaticDescriptorInitializer_messages_5frobocup_5fssl_5fdetection_2eproto() {
    proto_BuildDescriptors_messages_5frobocup_5fssl_5fdetection_2eproto();
  }
...
const SSL_DetectionBall SSL_DetectionBall::default_instance_;
...
const int SSL_DetectionBall::_offsets_[5] = {
...
const ::google::protobuf::Descriptor* SSL_DetectionBall::descriptor() {
  if (SSL_DetectionBall_descriptor_ == NULL) proto_BuildDescriptors_messages_5frobocup_5fssl_5fdetection_2eproto();
...
SSL_DetectionBall::GetReflection() const {
  return &_reflection_;
}

::google::protobuf::Message::Reflection* SSL_DetectionBall::GetReflection() {
  return &_reflection_;
}

// ===================================================================

const SSL_DetectionRobot SSL_DetectionRobot::default_instance_;
...
const int SSL_DetectionRobot::_offsets_[5] = {
...
const ::google::protobuf::Descriptor* SSL_DetectionRobot::descriptor() {
  if (SSL_DetectionRobot_descriptor_ == NULL) proto_BuildDescriptors_messages_5frobocup_5fssl_5fdetection_2eproto();
...
const ::google::protobuf::Message::Reflection*
SSL_DetectionRobot::GetReflection() const {
  return &_reflection_;
}

::google::protobuf::Message::Reflection* SSL_DetectionRobot::GetReflection() {
  return &_reflection_;
}

// ===================================================================

const SSL_DetectionFrame SSL_DetectionFrame::default_instance_;
...
const int SSL_DetectionFrame::_offsets_[5] = {
...
const ::google::protobuf::Descriptor* SSL_DetectionFrame::descriptor() {
  if (SSL_DetectionFrame_descriptor_ == NULL) proto_BuildDescriptors_messages_5frobocup_5fssl_5fdetection_2eproto();
...
const ::google::protobuf::Message::Reflection*
SSL_DetectionFrame::GetReflection() const {
  return &_reflection_;
}

::google::protobuf::Message::Reflection* SSL_DetectionFrame::GetReflection() {
  return &_reflection_;
}
